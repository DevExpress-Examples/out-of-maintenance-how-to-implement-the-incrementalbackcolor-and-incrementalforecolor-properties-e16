    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS " +
                "NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `QuantityPerUnit` IS NULL) OR (`Qu" +
                "antityPerUnit` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)))" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Products` SET `ProductName` = ?, `QuantityPerUnit` = ?, `UnitPrice` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `QuantityPerUnit` IS NULL) OR (`QuantityPerUnit` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Q212749.Properties.Settings.Default.nwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, QuantityPerUnit, UnitPrice FROM Products";
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, string Original_QuantityPerUnit, global::System.Nullable<decimal> Original_UnitPrice) {
        ...
        public virtual int Update(string ProductName, string QuantityPerUnit, global::System.Nullable<decimal> UnitPrice, int Original_ProductID, string Original_ProductName, string Original_QuantityPerUnit, global::System.Nullable<decimal> Original_UnitPrice) {
            if ((ProductName == null)) {
            ...
            if ((Original_QuantityPerUnit == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_QuantityPerUnit));
            }
            if ((Original_UnitPrice.HasValue == true)) {
